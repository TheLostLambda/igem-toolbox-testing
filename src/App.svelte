	...
	<div id="wrapper" class="grid-content">
		...
		<div id="IO">
			<div class="flex-column">
				...
				<textarea bind:value={dna} name="input" class="text-area" cols="30" rows="10"></textarea>
				<div class="title grid-title">
					<p>Output</p>
					<i class="fas fa-save"></i>
				...
				<textarea name="output" class="text-area" cols="30" rows="10">{wasm.count_bases(dna)}</textarea>
			</div>
		</div>
	</div>
</main>
